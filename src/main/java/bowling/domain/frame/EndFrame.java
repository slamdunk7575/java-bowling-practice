...
public class EndFrame implements Frame {
    ...
    public boolean isEnd() {
        ...
        return firstState.isFrameFinish() || count.isMax();
    }
    ...
    @Override
    public Frame next() {
        throw new IllegalArgumentException("End Frame 입니다.");
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(states, endFrame.states) && Objects.equals(count, endFrame.count);
    }
